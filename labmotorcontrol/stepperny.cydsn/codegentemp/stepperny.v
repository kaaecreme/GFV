...
module top ;
	...
	wire [0:0] tmpOE__B1_Purple_net;
	wire [0:0] tmpFB_0__B1_Purple_net;
	wire [0:0] tmpIO_0__B1_Purple_net;
	wire [0:0] tmpINTERRUPT_0__B1_Purple_net;
	electrical [0:0] tmpSIOVREF__B1_Purple_net;

	cy_psoc3_pins_v1_10
		#(.id("5e0b7d1b-28e7-439d-b006-0b0d15378eab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		B1_Purple
		 (.oe(tmpOE__B1_Purple_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B1_Purple_net[0:0]}),
		  .io({tmpIO_0__B1_Purple_net[0:0]}),
		  .siovref(tmpSIOVREF__B1_Purple_net),
		  .interrupt({tmpINTERRUPT_0__B1_Purple_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B1_Purple_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__A1_Green_net;
	wire [0:0] tmpFB_0__A1_Green_net;
	wire [0:0] tmpIO_0__A1_Green_net;
	wire [0:0] tmpINTERRUPT_0__A1_Green_net;
	electrical [0:0] tmpSIOVREF__A1_Green_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		A1_Green
		 (.oe(tmpOE__A1_Green_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A1_Green_net[0:0]}),
		  .io({tmpIO_0__A1_Green_net[0:0]}),
		  .siovref(tmpSIOVREF__A1_Green_net),
		  .interrupt({tmpINTERRUPT_0__A1_Green_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A1_Green_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__A2_Orange_net;
	wire [0:0] tmpFB_0__A2_Orange_net;
	wire [0:0] tmpIO_0__A2_Orange_net;
	wire [0:0] tmpINTERRUPT_0__A2_Orange_net;
	electrical [0:0] tmpSIOVREF__A2_Orange_net;

	cy_psoc3_pins_v1_10
		#(.id("975852ca-62ee-4be1-aa83-23ead96f4a4f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		A2_Orange
		 (.oe(tmpOE__A2_Orange_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A2_Orange_net[0:0]}),
		  .io({tmpIO_0__A2_Orange_net[0:0]}),
		  .siovref(tmpSIOVREF__A2_Orange_net),
		  .interrupt({tmpINTERRUPT_0__A2_Orange_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A2_Orange_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B2_White_net;
	wire [0:0] tmpFB_0__B2_White_net;
	wire [0:0] tmpIO_0__B2_White_net;
	wire [0:0] tmpINTERRUPT_0__B2_White_net;
	electrical [0:0] tmpSIOVREF__B2_White_net;

	cy_psoc3_pins_v1_10
		#(.id("995b9012-6748-49f1-9d93-6d27af8510a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		B2_White
		 (.oe(tmpOE__B2_White_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B2_White_net[0:0]}),
		  .io({tmpIO_0__B2_White_net[0:0]}),
		  .siovref(tmpSIOVREF__B2_White_net),
		  .interrupt({tmpINTERRUPT_0__B2_White_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B2_White_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
