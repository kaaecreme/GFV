// ======================================================================
// Exercise_2.v generated from TopDesign.cysch
// 03/04/2022 at 09:10
...
module top ;
	...
	wire [0:0] tmpOE__Pin_BI_SCL_net;
	wire [0:0] tmpFB_0__Pin_BI_SCL_net;
	wire [0:0] tmpINTERRUPT_0__Pin_BI_SCL_net;
	electrical [0:0] tmpSIOVREF__Pin_BI_SCL_net;

	cy_psoc3_pins_v1_10
		#(.id("a466c534-001a-4f13-a315-23618c3d62f4"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_BI_SCL
		 (.oe(tmpOE__Pin_BI_SCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_BI_SCL_net[0:0]}),
		  .io({Net_39}),
		  .siovref(tmpSIOVREF__Pin_BI_SCL_net),
		  .interrupt({tmpINTERRUPT_0__Pin_BI_SCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_BI_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_BI_SDA_net;
	wire [0:0] tmpFB_0__Pin_BI_SDA_net;
	wire [0:0] tmpINTERRUPT_0__Pin_BI_SDA_net;
	electrical [0:0] tmpSIOVREF__Pin_BI_SDA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_BI_SDA
		 (.oe(tmpOE__Pin_BI_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_BI_SDA_net[0:0]}),
		  .io({Net_53}),
		  .siovref(tmpSIOVREF__Pin_BI_SDA_net),
		  .interrupt({tmpINTERRUPT_0__Pin_BI_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_BI_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cba4938b-8a68-4c45-939e-dabe39bc5e78"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
