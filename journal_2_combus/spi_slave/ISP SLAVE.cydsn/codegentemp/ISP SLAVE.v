// ======================================================================
// ISP SLAVE.v generated from TopDesign.cysch
// 03/10/2022 at 14:50
...
module top ;
	...
	wire [0:0] tmpOE__Pin_1_LED_net;
	wire [0:0] tmpFB_0__Pin_1_LED_net;
	wire [0:0] tmpIO_0__Pin_1_LED_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1_LED_net;
	electrical [0:0] tmpSIOVREF__Pin_1_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1_LED
		 (.oe(tmpOE__Pin_1_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1_LED_net[0:0]}),
		  .io({tmpIO_0__Pin_1_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1_LED_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2_Button_net;
	wire [0:0] tmpFB_0__Pin_2_Button_net;
	wire [0:0] tmpIO_0__Pin_2_Button_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_Button_net;
	electrical [0:0] tmpSIOVREF__Pin_2_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("a800a8bf-ab05-4c0a-a4ea-99a700ba8208"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2_Button
		 (.oe(tmpOE__Pin_2_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2_Button_net[0:0]}),
		  .io({tmpIO_0__Pin_2_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2_Button_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
