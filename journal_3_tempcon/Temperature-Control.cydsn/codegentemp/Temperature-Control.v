...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed498c04-c9fa-4c8c-833a-b8507ce02dd7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("16c97fc5-cefb-4d46-85e3-019714b0eabe"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8585b7a4-d821-4ace-9a2a-fe7309c1e17f"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("adcec36a-2c66-4a78-8793-f2f71ffab2a2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("59c1f0c6-28f1-48ab-833e-eb57ad75fcc4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__controlSignal_net;
	wire [0:0] tmpFB_0__controlSignal_net;
	wire [0:0] tmpIO_0__controlSignal_net;
	wire [0:0] tmpINTERRUPT_0__controlSignal_net;
	electrical [0:0] tmpSIOVREF__controlSignal_net;

	cy_psoc3_pins_v1_10
		#(.id("d09ee25f-c3c1-4fff-b84f-9a9e5d74bcd7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		controlSignal
		 (.oe(tmpOE__controlSignal_net),
		  .y({Net_239}),
		  .fb({tmpFB_0__controlSignal_net[0:0]}),
		  .io({tmpIO_0__controlSignal_net[0:0]}),
		  .siovref(tmpSIOVREF__controlSignal_net),
		  .interrupt({tmpINTERRUPT_0__controlSignal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__controlSignal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
